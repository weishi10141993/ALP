...
#mass in GeV
n1Mass = "N/A"
mass_GammaD = "1" #pure string, this is for Axion like particle
mass_GammaD_Legend = "1" #numerical string, this is for axion like particle.
...
info.SetMargin(0.13)
info.SetHeader("#splitline{pp #rightarrow h  #rightarrow 2ALP #rightarrow 4#mu}{m_{h} = " + mass_Higgs +  " GeV, m_{ALP} = " + mass_GammaD_Legend + " GeV}" )
