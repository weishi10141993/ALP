...
WH = Parameter(name = 'WH',
               nature = 'internal',
               type = 'real',
               value = '0.00407 + (MH**3/16/cmath.pi/Lambda**2*cZh5**2*((-MALP**2/MH**2-MZ**2/MH**2+1)**2-4*MALP ** 2*MZ ** 2/MH ** 4) ** (3/2))+cah**2/32*246**2/cmath.pi*MH**3/Lambda**4*(1-2*MALP**2/MH**2)*cmath.sqrt(1-4*MALP**2/MH**2)',
               texname = '\\text{WH}',
               lhablock = 'DECAY',
               lhacode = [ 25 ])
